...
(function ($) {
        ...
        if ($['fn']['jQueryUIHelpers']['actions']) {
            for (var i = 0; i < $['fn']['jQueryUIHelpers']['actions'].length; i++) {
                elements.filter($['fn']['jQueryUIHelpers']['actions'][i]['filter']).each(function () {
                    $['fn']['jQueryUIHelpers']['actions'][i]['action']($(this), Util);
                });
            }
        }
    };
    ...
    Util['createOptions'] = createOptions;
    Util['tryConvert'] = tryConvert;
    Util['findObject'] = findObject;
    Util['resolveFunctions'] = resolveFunctions;
    Util['setFunctionOrValue'] = setFunctionOrValue;
