...
var GetColumns = function () {
    var columnsCreate = [[
        ["RequOrderID", "领料单号", 130, true],
        ["ApplyComName", "请领单位", 160, true],
        ["ProdPartName", "产品零件名称", 120, true],
        ["MaterielName", "加工原料名称", 150, true],
        ["ApplyAcount", "请领数量", 120, true],
        ["StorageAcount", "库存数量", 120, true]
    ]];
...
$(function () {
        Common.Functions.createDataGrid({
            ...
            //url: "/Store/AccSuppRequisition/Query", //需要获得向表中交互动态数据的后台路径
