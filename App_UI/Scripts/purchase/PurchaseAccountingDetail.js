...
$(function () {
    // 取得参数的外购单号
    var outOrderNo = $("#hdnOutOrderNo").val();
    // 需要合并的对象列
    var fields = ["MaterialNo", "MaterialName", "MaterialsSpecReq", "OrderQuantity", "OrderDate"];
    //创建datagrid
    Common.Functions.createDataGrid({
        //table容器,必须
        target: table,
        //获取数据的地址,必须
        url: "/Purchase/PurchaseAccountingDetail/Query?OutOrderNo=" + outOrderNo,
        //列属性,必须
        columns: getColumns(),
        //固定表示列
        frozenColumns: [[
