...
namespace Model
{
   [Serializable, Table("MC_WH_ACC_OUT_DETAIL_RECORD")]
    public class AccOutDetailRecord : Entity
    {
        public AccOutDetailRecord()
        {
           
        }
        /**
         * 附件库出库履历详细表 MC_WH_ACC_OUT_DETAIL_RECORD								
         * 
         * */

        //加工产品出库单号
        [Key, DatabaseGeneratedAttribute(DatabaseGeneratedOption.None), Column("SAEET_ID",Order=0)]
        [StringLength(20)]
        public string SaeetID { set; get; }

        //领料单详细号
        [Key, DatabaseGeneratedAttribute(DatabaseGeneratedOption.None), Column("PICK_LIST_DET_NO", Order = 1)]
        [StringLength(2)]
        ...
        //批次号
        [Key, DatabaseGeneratedAttribute(DatabaseGeneratedOption.None), Column("BTH_ID", Order = 2)]
        [StringLength(20)]
