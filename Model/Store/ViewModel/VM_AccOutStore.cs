...
// 版权所有。
//
// 文件名：VM_AccOutStore.cs
// 文件功能描述：
//          附件库（待出库一览、出库登录、出库履历一览、附件库出库打印预览）画面Model
//          即附件库出库相关画面
//
...
namespace Model
{
    ...
    public class VM_AccOutStoreForSearch
    {
        /// <summary>
        /// 领料单号
        /// </summary>
    ...
    } //end VM_AccOutStoreForSearch

    public class VM_AccOutStoreForTableShow
    {
        /// <summary>
        /// 领料单号
        /// </summary>
    ...
    } //end VM_AccOutStoreForTableShow

    #endregion
    
    #region 附件库出库登录
     public class VM_AccOutLoginStoreForTableShow
     {
            //领料单号
           ...
           // public string AccLoginFlg { set; get; }
            ...
            //物料名称
            public string MaterielName { set; get; }
         
        }


     public class VM_AccOutLoginStoreForSearch
     {
         //出库区分
    ...
    #region 附件库出库批次选择
     public class VM_AccOutBthForTableShow
     {
         //数量
         public decimal Qty { set; get; }
    ...
    #region 附件库出库履历一览
     public class VM_AccOutRecordStoreForTableShow
     {
         //领料单号
         public string PickListID { set; get; }
     ...
     public class VM_AccOutRecordStoreForSearch
     {
         //领料单号
         public string PickListID { set; get; }
    ...
    #region 附件库出库打印选择
     ...
     public class VM_AccOutPrintForSearch
     {
         /// <summary>
         /// 领料单号
         /// </summary>
         ...
         /// </summary>
         public string WhID { set; get; }
     } //end VM_AccOutPrintForSearch

     public class VM_AccOutPrintForTableShow
     {
         /// <summary>
         /// 打印状态
         /// </summary>
     ...
     } //end VM_AccOutPrintForTableShow

     #endregion

    #region 附件库出库打印预览

     public class VM_AccOutPrintIndexForTableShow
     {
         /// <summary>
         /// 加工产品出库单据号
         /// </summary>
     ...
     } //end VM_AccOutPrintIndexForTableShow

     public class VM_AccOutPrintIndexForInfoShow
     {
         /// <summary>
         /// 加工产品出库单号
         /// </summary>
     ...
     } //end VM_AccOutPrintIndexForInfoShow
