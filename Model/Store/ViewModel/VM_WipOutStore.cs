...
// 版权所有。
//
// 文件名：VM_WipOutStore.cs
// 文件功能描述：
//          在制品库（待出库一览、出库登录、出库履历一览、在制品库出库打印预览）画面Model
//          即在制品库出库相关画面
//
...
namespace Model
{
    ...
    public class VM_WipOutStoreForSearch
    {
        /// <summary>
        /// 领料单号
        /// </summary>
    ...
    } //end VM_WipOutStoreForSearch

    public class VM_WipOutStoreForTableShow
    {
        /// <summary>
        /// 领料单号
        /// </summary>
    ...
    } //end VM_WipOutStoreForTableShow
    
    #endregion
    
    #region 在制品库出库登录
     public class VM_WipOutLoginStoreForTableShow
     {
         //领料单号
     ...
     public class VM_WipOutLoginStoreForSearch
     {
         //出库区分
    ...
    #region 在制品库出库批次选择
     public class VM_WipOutBthForTableShow
     {
         //数量
         public decimal Qty { set; get; }
    ...
    #region 在制品库出库批次选择临时表
     public class VM_WipOutBthForDTableShow
     {
         //数量
         public decimal Qty { set; get; }
    ...
    #region 在制品库出库履历一览
     public class VM_WipOutRecordStoreForTableShow
     {
         //领料单号
         public string PickListID { set; get; }
     ...
     public class VM_WipOutRecordStoreForSearch
     {
         //领料单号
         public string PickListID { set; get; }
    ...
    #region 在制品库出库打印选择
     ...
     public class VM_WipOutPrintForSearch
     {
         /// <summary>
         /// 领料单号
         /// </summary>
         ...
         /// </summary>
         public string WhID { set; get; }
     } //end VM_WipOutPrintForSearch

     public class VM_WipOutPrintForTableShow
     {
         /// <summary>
         /// 打印状态
         /// </summary>
    ...
    #region 在制品库出库打印预览
     ...
     public class VM_WipOutPrintIndexForInfoShow
     {
         /// <summary>
         /// 加工产品出库单号
         /// </summary>
     ...
     } //end VM_WipOutPrintIndexForInfoShow

     public class VM_WipOutPrintIndexForTableShow
     {
         /// <summary>
         /// 加工产品出库单据号
         /// </summary>
